...
const SignInOverlay = ({ isOpen, onClose, onSwitchToSignUp, onSuccess }) => {
    ...
    >
      ...
      >
        ...
        <div className="bg-white border-b border-gray-100 p-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 text-sm mt-1">Welcome back to Project Phi</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh]">
          <Login 
            onSwitchToRegister={onSwitchToSignUp}
            onSuccess={onSuccess}
            isModal={true}
          />
        </div>
